...
<footer class="py-4 py-md-5 bg-black" >
  ...
  <div>
    ...
    <div class="widget">
            <h4 class="widget-title text-light mb-1 fs-7 ">Contáctanos</h4>
            <p class="mb-4 text-light">
              Tantoyuca, Veracruz, Mexico. </br>
              jesusramirezmartines@gmail.com </br>
              7891207667 </br>
            </p>
      <div class="row gy-3 align-items-lg-center">
        <div class="col-12 col-lg-6 order-1 order-lg-0">
          <div class="copyright-wrapper d-block mb-1 fs-7 text-light text-start">
            &copy; 2024. Todos lo derechos reservados.
          </div>
          <div class="credit-wrapper d-block text-light fs-8 text-start">
            Hecho por Jesús Ramírez Martínez
          </div>
        </div>
